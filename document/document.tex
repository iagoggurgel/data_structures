...
\definirtitulocurto{Relatório sobre Estrutura de Dados}
...
\include{content/chapter/2/text} % Análise de algoritmos de Ordenação
\include{content/chapter/3/text} % Análise de algoritmos de Árvores e Tabelas de Dispersão
% \include{content/chapter/4/text} % Grafos
% \include{content/chapter/5/text} % Conclusão
...
%\include{content/appendix/2/text}
%\include{content/appendix/3/text}
%\include{content/appendix/4/text}
%\include{content/appendix/5/text}
%\include{content/appendix/6/text}
